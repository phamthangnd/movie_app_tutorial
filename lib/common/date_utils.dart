...
String? stringifyDate([DateTime? timestamp]) {
  final formatter = DateFormat('dd/MM/yyyy');
  return formatter.format(timestamp ?? DateTime.now());
}

String? stringifyMonthOfDate([DateTime? dateTime]) {
  final formatter = DateFormat('MMM', 'vi');
  if (dateTime == null) return formatter.format(DateTime.now());
...
class DateUtils {
  ...
  static const List<String> weekdays = ['CN', 'T2', 'T3', 'T4', 'T5', 'T6', 'T7'];
