...
class DateFormats {
  ...
  static String vi_full = 'dd/MM/yyyy HH:mm:ss';
  static String vi_y_mo_d_h_m = 'yyyy/MM/dd HH:mm';
  static String vi_y_mo_d = 'yyyy/MM/dd';
  static String vi_y_mo = 'yyyy/MM';
  static String vi_mo_d = 'MM/dd';
  static String vi_mo_d_h_m = 'MM/dd HH:mm';
  static String vi_h_m_s = 'HH:mm:ss';
  static String vi_h_m = 'HH:mm';
}
